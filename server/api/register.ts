...
// Imagen por defecto para los nuevos usuarios
const DEFAULT_PROFILE_PIC = "/images/defaultProfilePic.jpg";
...
export default defineEventHandler(async (event) => {
    ...
    const newUser = await prisma.user.create({
        data: {
            ...
            profilePic: DEFAULT_PROFILE_PIC, // Asignamos la imagen por defecto aquí
        },
    });
    ...
    // Devolver el usuario creado con éxito
    return {
